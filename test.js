 ...
 * Agrega un numero 4 en la cuarta posición y no elimina ningun elemento
  * */
...
console.log('Arreglo despues de splice: ' + arr);
...
/* Aceptar multiples parametros en una función 'rest parameters' */
