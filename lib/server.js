...
const pizza = require('../handlers/homework3-pizza')
...
lib.router = {
  ...
  'checks/all': webChecks.list,
  'checks/create': webChecks.create,
  'checks/edit': webChecks.edit,
  'pizza/menu': pizza.items,
  'pizza/shopping': pizza.shopping,
  'pizza/add': pizza.add,
  'pizza/payment': pizza.payment,
  'pizza/order': pizza.order,
  'pizza/send/order': pizza.send,
  ping: homework1.ping,
